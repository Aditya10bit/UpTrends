...
import { AnimatedProgress, GenderToggle } from '../../components/TwinningSharedComponents';
...
export default function FriendsTwinningScreen() {
  ...
  const [photos, setPhotos] = useState<PhotoSlot[]>([
    ...
    },
    {
      id: 'person2',
      title: 'Friend',
      subtitle: 'Upload friend\'s photo',
      icon: '👤',
      required: true,
      needsName: true,
      needsGender: true,
      placeholder: 'Tap to add friend\'s photo'
    },
    {
      id: 'together',
      title: 'Squad Photo',
      subtitle: 'All friends together',
      icon: '👥',
      required: true,
  ...
  const [friendsContext, setFriendsContext] = useState({
    hangoutType: '',
    location: '',
    vibe: '',
    activities: '',
  ...
  const canAnalyze = () => {
    try {
      ...
      const hasRequiredContext = friendsContext.hangoutType?.trim() && friendsContext.location?.trim();
      ...
      console.log('🔍 Validation check:', {
        ...
        hangoutType: friendsContext.hangoutType,
        location: friendsContext.location
      });
  ...
  const simulateAnalysisProgress = () => {
    const initialSteps = [
      `🎯 Starting comprehensive analysis for your perfect coordination...`,
      ...
      `👤 Scanning ${names.person2 || 'Person 2'}'s vibe and energy...`,
      ...
      `👥 Understanding your friendship dynamic and chemistry...`,
      `🏛️ Analyzing the ${friendsContext?.hangoutType || 'venue'} setting and atmosphere...`,
      `🎨 Creating complementary color schemes for coordination...`,
      `🤖 Getting AI fashion recommendations...`,
      `👕 Generating coordinated squad outfits based on analysis...`,
      `🛍️ Creating specific shopping links for each outfit item...`,
      `💡 Developing personalized styling tips for your squad...`,
      `✨ Finalizing your perfect squad coordination...`
    ];
    ...
    return {
      ...
      addFinalStep: () => {
        try {
          const finalStepText = `🎉 Your perfect twinning analysis is ready!`;
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const result = await analyzeTwinningPhotos(
        ...
        names,
        'friends',
        `${friendsContext.hangoutType} at ${friendsContext.location}`,
        { ...friendsContext, friendGender }
      );
  ...
  // Safety check: ensure friendsContext object is valid
  if (!friendsContext || typeof friendsContext !== 'object') {
    return (
      <View style={styles.container}>
      ...
      <View style={[styles.container, { backgroundColor: theme.background }]}>
        ...
        >
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerTitleSection}>
              <Text style={styles.headerTitle}>Twin with Friends</Text>
              <Text style={styles.headerSubtitle}>Squad goals coordination</Text>
            </View>
        ...
        >
          ...
          <Animated.View style={[styles.instructionsCard, animatedStyle]}>
                        <LinearGradient
                            colors={['rgba(79,172,254,0.1)', 'rgba(0,242,254,0.05)'] as any}
                        ...
                        >
                            ...
                            Upload photos of your friend group and get AI-powered coordinated outfit suggestions for your perfect squad look
                            </Text>
                        </LinearGradient>
                    </Animated.View>
          ...
          <View style={styles.uploadSection}>
            {theme ? (
              ...
              <Text style={{ color: '#4facfe' }}>Upload Photos</Text>
            )}
                ...
                .map((photo, index) => (
                  theme ? (
                    <PhotoUploadCard
                      ...
                      onGenderChange={photo.id === 'person2' ? setFriendGender : undefined}
                      gender={photo.id === 'person2' ? friendGender : undefined}
                    />
                  ) : (
            ...
            {theme ? (
              <>
                ...
                <Text style={[styles.sectionSubtitle, { color: theme.textSecondary }]}>
                  Help us create the perfect squad coordination for your friendship goals
                </Text>
              </>
            ) : (
              <>
                <Text style={{ color: '#4facfe' }}>Tell us about your hangout</Text>
                <Text style={{ color: '#666' }}>Help us create the perfect squad coordination for your friendship goals</Text>
              </>
            )}
              ...
              {theme ? (
                <>
                  <ContextInputCard
                    title="Hangout Type"
                    icon="people"
                    placeholder="e.g., Casual meetup, Party, Shopping, Adventure..."
                    value={friendsContext.hangoutType}
                    onChangeText={(text) => setFriendsContext(prev => ({ ...prev, hangoutType: text || '' }))}
                    theme={theme}
                    primaryColor="#4facfe"
                    required
                  />
                  ...
                  <ContextInputCard
                    ...
                    icon="location"
                    placeholder="e.g., Mall, Beach, Cafe, Club, Park..."
                    value={friendsContext.location}
                    onChangeText={(text) => setFriendsContext(prev => ({ ...prev, location: text || '' }))}
                    theme={theme}
                    primaryColor="#4facfe"
                    required
                  />
                  ...
                  <ContextInputCard
                    title="Vibe & Mood"
                    icon="happy"
                    placeholder="e.g., Chill, Energetic, Trendy, Laid-back..."
                    value={friendsContext.vibe}
                    onChangeText={(text) => setFriendsContext(prev => ({ ...prev, vibe: text || '' }))}
                    theme={theme}
                    primaryColor="#4facfe"
                  />
                  ...
                  <ContextInputCard
                    ...
                    placeholder="e.g., Dancing, Photos, Food, Games..."
                    value={friendsContext.activities}
                    onChangeText={(text) => setFriendsContext(prev => ({ ...prev, activities: text || '' }))}
                    theme={theme}
                    primaryColor="#4facfe"
                  />
                  ...
                  <ContextInputCard
                    title="Group Dynamic"
                    icon="heart"
                    placeholder="e.g., Best friends, College buddies, Work friends..."
                    value={friendsContext.groupDynamic}
                    onChangeText={(text) => setFriendsContext(prev => ({ ...prev, groupDynamic: text || '' }))}
                    theme={theme}
                    primaryColor="#4facfe"
                    multiline
                  />
                  ...
                  <ContextInputCard
                    title="Style Goals"
                    icon="star"
                    placeholder="e.g., Instagram-worthy, Comfortable, Matching..."
                    value={friendsContext.styleGoals}
                    onChangeText={(text) => setFriendsContext(prev => ({ ...prev, styleGoals: text || '' }))}
                    theme={theme}
                    primaryColor="#4facfe"
                    multiline
                  />
               ...
               >
                   ...
                   <View style={styles.analyzeContent}>
                     ...
                     <Text style={styles.analyzeButtonText}>
                       {canAnalyze() ? 'Generate Squad Coordination' : 'Complete Required Fields'}
                     </Text>
                ...
                <View
                  style={[
                    styles.progressFill,
                    {
                      ...
                      backgroundColor: canAnalyze() ? '#22c55e' : '#4facfe'
                    }
                  ]}
                />
              </View>
...
// Reuse the PhotoUploadCard component from date.tsx with slight modifications
...
function PhotoUploadCard({
  ...
  return (
    <Animated.View style={[styles.photoCard, cardAnimatedStyle]}>
        ...
        <Animated.View style={[
          ...
          {photo.image ? (
            ...
            <View style={styles.photoPlaceholder}>
              <Animated.View style={[styles.shimmerOverlay, shimmerStyle]}>
                <LinearGradient
                  colors={['transparent', 'rgba(79,172,254,0.3)', 'transparent']}
                  style={styles.shimmerGradient}
                  start={{ x: 0, y: 0 }}
                  end={{ x: 1, y: 0 }}
                />
              ...
              <View style={[styles.iconContainer, { backgroundColor: 'rgba(79,172,254,0.1)' }]}>
              ...
              {photo.required && (
                <View style={[styles.requiredBadge, { backgroundColor: '#4facfe' }]}>
      ...
      {photo.needsGender && onGenderChange && gender && (
        <GenderToggle
          gender={gender}
  ...
  if (analyzing) {
    return (
      <View style={[styles.resultsContainer, { backgroundColor: theme.background }]}>
        ...
        <LinearGradient
          colors={[primaryColor, '#00f2fe'] as any}
        ...
        >
          <View style={styles.resultsHeaderContent}>
            ...
            <Text style={styles.resultsTitle}>Analyzing Your Squad</Text>
    ...
    <View style={[styles.resultsContainer, { backgroundColor: theme.background }]}>
      ...
      >
        <View style={styles.resultsHeaderContent}>
          ...
          <Text style={styles.resultsTitle}>Your Perfect Squad Look</Text>
          <View style={styles.headerSpacer} />
        </View>
      </LinearGradient>
      ...
      <ScrollView style={styles.resultsScroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.summaryCard, { backgroundColor: theme.card }]}>
          ...
          <Text style={[styles.summaryText, { color: theme.textSecondary }]}>
            {analysis.relationship?.dynamic || 'Perfect squad coordination'}
          </Text>
        </View>
                ...
                {(analysis.outfitSuggestions?.[index === 0 ? 'person1' : 'person2'] || [])
                  ...
                  <View key={outfitIndex} style={[styles.outfitCard, { backgroundColor: theme.background }]}>
                    ...
                    <Text style={[styles.outfitWhy, { color: theme.textSecondary }]}>
                      {outfit.why_this_works || 'Perfect for your style'}
                    </Text>
        ...
        <View style={[styles.coordinationCard, { backgroundColor: theme.card }]}>
          ...
          <Text style={[styles.coordinationTheme, { color: theme.textSecondary }]}>
            {analysis.outfitSuggestions?.coordination?.overall_theme || 'Perfect coordination for your squad'}
          </Text>
...
// Reuse styles from date.tsx with color adjustments
