...
export default function FriendsTwinningScreen() {
  ...
  const canAnalyze = () => {
    try {
      ...
      const hasRequiredContext = friendsContext.occasion?.trim() !== '';
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      const result = await analyzeTwinningPhotos(
        ...
        names,
        'friends',
        `${friendsContext.occasion} - ${friendsContext.specificNotes}`,
      ...
      setProgressSteps(['🎉 Your perfect twinning analysis is ready!']);
      setCurrentStep(5);
  ...
  return (
    <PremiumBackground variant="friends">
              ...
              {theme ? (
                <>
                  <ContextInputCard
                    ...
                    value={friendsContext.occasion}
                    onChangeText={(text) => setFriendsContext(prev => ({ ...prev, occasion: text || '' }))}
                    theme={theme}
                    primaryColor="#4facfe"
                    required
                  />
                  ...
                  <ContextInputCard
                    ...
                    value={friendsContext.specificNotes}
                    onChangeText={(text) => setFriendsContext(prev => ({ ...prev, specificNotes: text || '' }))}
                    theme={theme}
                    primaryColor="#4facfe"
                    multiline
                  />
  ...
  return (
    <Animated.View style={[styles.contextCard, animatedStyle]}>
      ...
      {title === 'Occasion' && (
        ...
        >
          {['Casual Hangout', 'Party / Club', 'Dinner Date', 'Shopping', 'Travel', 'Concert'].map(chip => (
            <TouchableOpacity 
              key={chip}
              style={[
                styles.chipButton, 
